...
public class frmJogos extends javax.swing.JFrame {
   ...
   int Codigo = Integer.parseInt(this.txtExcluir.getText());
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        try{
            String cod = this.txtBuscar.getText();
            lista = c1.Buscar(cod);
            DefaultTableModel dados = (DefaultTableModel) tbl.getModel();
            dados.setNumRows(0);
            for (model md: lista){
                dados.addRow(new Object[]{md.getNome(),md.getCodigo(),md.getCategoria()});
            }
        }
            catch (SQLException ex){
